...
$string['loginbackgroundimagesmallsetting'] = 'Mobile Login page background images';
$string['loginbackgroundimagesmallsetting_desc'] = 'Images uploaded in this setting will be randomly displayed on the login page as background images on smaller devices.';
