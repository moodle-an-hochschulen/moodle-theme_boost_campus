...
/**
 * Step definitions related to blocks overrides for the BFH theme.
 *
 * @package    theme_boost_campus
 * @category   test
 * @copyright  2019 Luca Bösch
...
/**
 * Blocks management step definitions for the Boost Campus theme.
 *
 * @package    theme_boost_campus
 * @category   test
 * @copyright  2019 Luca Bösch
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_boost_campus_behat_blocks extends behat_blocks {
    ...
    public function i_add_the_block($blockname) {
        ...
        // Surround by try catch since the add block link could also be elsewhere.
        try {
            ...
            // Select $blockname in the $addblock form.
            $this->execute('behat_forms::i_set_the_field_to', array($addblock, $blockname));
        }
    }
